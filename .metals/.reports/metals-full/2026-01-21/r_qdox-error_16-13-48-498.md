error id: file://<WORKSPACE>/taskmanager/src/main/java/pl/taskmanager/taskmanager/config/H2ConsoleConfig.java
file://<WORKSPACE>/taskmanager/src/main/java/pl/taskmanager/taskmanager/config/H2ConsoleConfig.java
...
```java
offset: 0
uri: file://<WORKSPACE>/taskmanager/src/main/java/pl/taskmanager/taskmanager/config/H2ConsoleConfig.java
text:
```scala
@@
```
...
QDox parse error in file://<WORKSPACE>/taskmanager/src/main/java/pl/taskmanager/taskmanager/config/H2ConsoleConfig.java
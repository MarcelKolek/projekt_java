error id: file://<WORKSPACE>/taskmanager/src/main/java/pl/taskmanager/taskmanager/dto/TaskRequest.java
file://<WORKSPACE>/taskmanager/src/main/java/pl/taskmanager/taskmanager/dto/TaskRequest.java
...
```java
offset: 298
uri: file://<WORKSPACE>/taskmanager/src/main/java/pl/taskmanager/taskmanager/dto/TaskRequest.java
text:
```scala
...
QDox parse error in file://<WORKSPACE>/taskmanager/src/main/java/pl/taskmanager/taskmanager/dto/TaskRequest.java
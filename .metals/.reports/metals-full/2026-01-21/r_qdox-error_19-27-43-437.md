error id: file://<WORKSPACE>/taskmanager/src/main/java/pl/taskmanager/taskmanager/dto/CategoryRequest.java
file://<WORKSPACE>/taskmanager/src/main/java/pl/taskmanager/taskmanager/dto/CategoryRequest.java
...
```java
offset: 0
uri: file://<WORKSPACE>/taskmanager/src/main/java/pl/taskmanager/taskmanager/dto/CategoryRequest.java
text:
```scala
@@
```
...
QDox parse error in file://<WORKSPACE>/taskmanager/src/main/java/pl/taskmanager/taskmanager/dto/CategoryRequest.java